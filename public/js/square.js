...
const questionTypeExpId = "square_area_question_type";
const motivationalSupportTypeExpId = "square_area_motivational_support_type";
...
window.addEventListener("load", async () => {
    ...
    switch (questionType) {
        case "Decontextual":
            questionText.innerHTML = "A square has a side length of <b>10</b> inches.<br>What is the <b>area</b> of the square?";
            contextuals.forEach(contextual => contextual.style.display = "none");
            break;
        case "Contextual":
            questionText.innerHTML = "A napkin has a side length of <b>10</b> inches.<br>What is the <b>area</b> of the napkin?";
